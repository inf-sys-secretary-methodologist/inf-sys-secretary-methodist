...
// author-scoped operations (Submit / DiscardDraft in PR 3a). The
// predicate intentionally does NOT accept methodist — methodist's
// authorship rights are bounded to Create (per ADR-018 ADR-5 "резервно
// creates если teacher не успевает"); ongoing operations on an existing
// WP belong either to its actual author or to system_admin override.
