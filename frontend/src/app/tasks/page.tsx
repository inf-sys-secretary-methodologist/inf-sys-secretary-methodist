    ...
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 pt-24">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Управление задачами</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Создание, отслеживание и выполнение задач
          </p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl p-8 bg-white dark:bg-black/95 border border-gray-200 dark:border-gray-700">
          <div className="relative z-10 space-y-6 text-center">
            <ListTodo className="h-16 w-16 mx-auto text-gray-400" />
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
              Раздел в разработке
            </h2>
            <p className="text-gray-600 dark:text-gray-400">
              Здесь будет отображаться список задач, их статусы и приоритеты
            </p>
          </div>
        </div>
      </div>
