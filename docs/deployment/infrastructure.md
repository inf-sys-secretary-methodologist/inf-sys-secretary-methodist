...
### Distributed Tracing:
- **Grafana Tempo** для хранения и поиска трейсов
- **OpenTelemetry SDK** для инструментирования Go-кода
- **OTEL Collector** для сбора и экспорта трейсов
- **Correlation IDs** для связывания логов с трейсами
- **Service Map** в Grafana для визуализации зависимостей
