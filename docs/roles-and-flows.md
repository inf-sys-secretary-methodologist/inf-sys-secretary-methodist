...
**Видит в меню:** Dashboard, Documents (просмотр), Calendar, Messages, AI Assistant, Profile
...
4. **Calendar** — свои события, расписание группы
5. **Messages** — WebSocket-чаты
6. **AI Assistant** — RAG с цитированием
7. **Tasks** — просмотр заданий (own read+execute)
8. **Announcements** — просмотр объявлений
9. *(Личные настройки — стандартно для всех ролей)*

**Что НЕ может:** создавать документы, отчёты (`denied`), аналитика, управление пользователями, любые системные настройки.

---

### 👨‍🏫 Преподаватель (`teacher`)

**Видит в меню:** Dashboard, Documents (full), Calendar, Messages, AI Assistant, Users (limited), Profile
...
6. **Reports (limited)** — по своим группам, экспорт limited
7. **Messages** — групповые чаты со студентами
8. **AI Assistant** — расширенные права на RAG
9. *(Личные настройки — стандартно)*

**Что НЕ может:** видеть отчёты других преподавателей, управлять curriculum, создавать пользователей, любые системные настройки.
...
✅ **Готово к продакшну (12 модулей):** auth, users, documents, dashboard, notifications, messaging, reporting, integration *(admin-only)*, analytics, ai, **tasks**, **announcements**
